...
#  nstart: Integer, number of initializations for k-means
#
# Returns: A matrix consisting of the community detection errors and runtimes for predictive assignment using SC for different values of p = (log m)/(log n)
...
# To reproduce the spectral clustering results in Tables 2 and 3,
...
# See peakram_SBM.R for demonstration.