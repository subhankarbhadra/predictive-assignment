...
peakRAM(effclustering(A, k, 0.80, "cc", F, niter, nstart))
peakRAM(effclustering(A, k, 0.85, "cc", F, niter, nstart))
peakRAM(effclustering(A, k, 0.90, "cc", F, niter, nstart))
peakRAM(effclustering(A, k, 0.95, "cc", F, niter, nstart))
peakRAM(specclustering(A, k, F, niter, nstart))
